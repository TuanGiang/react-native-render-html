...
export default class HTMLImage extends PureComponent {
    ...
    getImageSize (props = this.props) {
        ...
        if (styleWidth && styleHeight) {
           ...
           const     height = typeof styleHeight === 'string' && styleHeight.search('%') !== -1 ? styleHeight : typeof width === 'string' ? 1000 : (width * parseInt(styleHeight, 10)) / parseInt(styleHeight, 10);
           alert (width +"  " +height);
